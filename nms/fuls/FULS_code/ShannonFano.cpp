...
int ShannonFano::compare_probs(const void * elem1, const void * elem2)
{
...
void ShannonFano::encodeRecursize(int start, int end)
{
...
void ShannonFano::Decode(string  input, string  output)
{
...
void ShannonFano::Encode(string  input, string  output)
{
	char ch;
	ifstream inputData;
	inputData.open(input);
