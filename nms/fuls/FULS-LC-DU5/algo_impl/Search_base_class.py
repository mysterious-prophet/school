...
class Search():
	...
	def inner_search(self, text, pattern):
	...
	def search(self, text, keywords):
		...
		print("Search start: \t" + str(datetime.now()))

		for word in keywords:
			p_temp, s_temp = self.inner_search(text, word)
			preprocess_t_ms += p_temp
			search_t_ms += s_temp

		print("Search finish: \t" + str(datetime.now()))
