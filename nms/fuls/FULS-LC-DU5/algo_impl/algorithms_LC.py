...
from algo_settings import READ_FILE_BY_ROW, DEC_ACCURACY, ITERATIONS, PRINT_MATCH_INFO, EXPORT_INDIVIDUAL_RUNS, TIME_IN_SECONDS
import csv_summary
...
from DKA_algo_impl_class import DKASearch
...
#DATA_PATH = Path('input_data/data_1_21-15-33-578420_400000_rows.csv')
...
def main():
	...
	file_size = round(DATA_PATH.stat().st_size/(1024*1024.0), 2)
	# Search for this pattern
	pattern = ["Sit", "ipsum", "asdasdasd", "123456", "Sita", "ipsuma", "asdasdasda", "1234567", "asdasdasdad", "12345678"]
	#pattern = ["Sit"]
	...
	algorithms = [ElementarySearch(), KMPSearch(), BMSearch(), ACSearch(), CWSearch(), DKASearch()]
	...
	csv_summary.create_summary_csv("benchmark_summary_table-" + str(DATA_PATH.name) + ".csv", file_size, algorithms, EXPORT_INDIVIDUAL_RUNS, TIME_IN_SECONDS)
