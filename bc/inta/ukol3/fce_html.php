...
function escape_html($vst){
	$vysledek = filter_input($vst, FILTER_SANITIZE_SPECIAL_CHARS);
	if ($vysledek===FALSE)
		echo "<p>vstup nelze escapovat pro HTML!</p>";
	elseif ($vysledek===NULL)
		echo "<p>vstup neni zadan</p>";
	else
		echo "<p>Byl zadán tento text: $vysledek</p>";
}
