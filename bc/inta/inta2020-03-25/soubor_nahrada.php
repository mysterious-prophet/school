...
echo "<h3>Soubor po $kolik náhradách:</h3>";
...
*/
echo '<div style="background-color:#FFFFFF">'.nl2br($str2).'</div>'; // místo konců řádků je <br>;  
echo '<h3>Soubor před náhradami:</h3>';
echo '<div style="background-color:#CCFFCC">',nl2br(html_escape($str)),'</div>';
