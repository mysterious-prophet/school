...
foreach ($jmenaTrid as $trida){
  $metodyTridy = get_class_methods($trida);
  foreach ($metodyTridy as $metoda){
	  if((preg_match('/(([a-zA-Z]*_?)*)(E|e)xecute((_?[a-zA-Z]*)*)/', $metoda)) || (preg_match('/(([a-zA-Z]*_?)*)(Q|q)uery((_?[a-zA-Z]*)*)/', $metoda))){
		  echo "<br>$trida";
